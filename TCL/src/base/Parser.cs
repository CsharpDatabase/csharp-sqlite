...
namespace tcl.lang
{
  ...
  public class Parser
  {
    ...
    public static ParseResult parseVar( Interp interp, string inString )
    {
      ...
      var src = new CharPointer( inString );
        ...
        case 'x':
          ...
          if ( script_index < endIndex )
          {
            ...
            if ( ( ( c >= '0' ) && ( c <= '9' ) ) || ( ( c >= 'A' ) && ( c <= 'F' ) ) || ( ( c >= 'a' ) && ( c <= 'f' ) ) )
            {
              ...
              var str = new string( script_array, script_index, endIndex - script_index );
...
getoctal_brk:
    ...
    internal static void init( Interp interp )
    {
      ...
      var OBJV = new TclObject[OBJV_CACHE_MAX][][];
      var USED = new int[OBJV_CACHE_MAX];
